 ...
 * \brief Solve the generalized eigenvalue problem for two matrices. FIXME
 *
 ...
 *
 */
void find_eigenvalues(gsl::not_null<ComplexDataVector*> eigenvalues,
                      gsl::not_null<blaze::DynamicMatrix<std::complex<double>,
                                                         blaze::columnMajor>*>
                          matrix,
                      gsl::not_null<DataVector*> scratch);
